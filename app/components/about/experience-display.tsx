...
export default function ExperienceDisplay({
  ...
  return (
    <div className="flex gap-4 mb-2 p-4 bg-green-950 rounded-4xl border-gray-50 border-1">
      <div>
        <svg
      ...
      <div className="flex-1">
        <h3>{data.experiences[0].organization}</h3>
        <h4>
          {data.experiences[
      ...
      {data.experiences.map((experience) => {
        return (
          <div key={experience.title + "experience"}>
