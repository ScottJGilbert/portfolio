  ...
  return (
    ...
    >
      <div className="max-w-3xl space-y-8">
        ...
        <Link
          href="/about"
          className="bg-surface-alt group relative inline-flex items-center justify-center gap-(--space-xs) rounded-full border border-primary/25 px-8 py-4 text-sm font-bold uppercase tracking-[0.16em] text-primary shadow-ambient overflow-hidden transform transition duration-300 ease-out hover:scale-105 hover:brightness-105 active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          ...
          <span className="relative z-10">
            {content.ctaLabel}
            <span className="sr-only"> about Scott Gilbert</span>
          </span>
        </Link>
      </div>
    </section>
