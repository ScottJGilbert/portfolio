  ...
  return (
    <ProjectShell project={project}>
      ...
      <p>
        ...
        organization&apos;s day-to-day decisions and its technical direction.
        The platform is organized around containerized services that support
        gaming, authentication, user management, and data pipelines.
      </p>
    </ProjectShell>
  );
}
