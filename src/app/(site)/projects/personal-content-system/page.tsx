...
export default function PersonalContentSystemPage() {
  ...
  return (
    <ProjectShell project={project}>
      ...
      <p>
        The Personal Content System brings together the public-facing
        portfolio, structured content, authentication, workflow automation,
        and the services that support them. The goal is to make publishing
        flexible without losing the reliability and maintainability expected
